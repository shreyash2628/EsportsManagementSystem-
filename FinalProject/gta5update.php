...
//See if the fields are empty
{
 ...
 //if the fields are not empty   
    else
    {
        ...
        $sql = "UPDATE gta SET MatchesPlayed = '$MatchesPlayed', Lost = '$Lost', Penalty = '$Penalty', Score = '$Score' , Won = '$Won' , TeamName = '$TeamName' WHERE id = $id";  
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <?php
   ...
   {
    $sql = "SELECT * FROM gta WHERE id = '{$_REQUEST['id']}'";
  ...
  <div class="text-center">
    <button type="submit" class="btn btn-danger" id="gta" name="gta">Update</button>
    <a href="gta5.php" class="btn btn-secondary">Close</a>
  </div>
