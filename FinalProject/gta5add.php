...
//See if the fields are empty
{
 ...
 //if the fields are not empty   
    else
    {
        ...
        $sql = "INSERT INTO gta (MatchesPlayed, Lost, Penalty, Score, TeamName, Won) VALUES ('$matchesplayed', '$lost', '$Penalty', '$Score', '$TeamName', '$Won')";
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <button type="submit" class="btn btn-danger" id="gtasubmit" name="gtasubmit">Add</button>
