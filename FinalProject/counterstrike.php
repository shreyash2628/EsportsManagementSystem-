...
?>
    ...
    <div class="col-md-10 mt-5 text-left">
        ...
        <div class="col-sm-4 col-md-10 mt-5 text-center">
            <p class="bg-dark text-white p-2">COUNTER STRIKE SCOREBOARD</p>
            <?php            
$sql ="SELECT * FROM counterstrike";
...
if($result->num_rows > 0)
{
    ...
    while($row = $result->fetch_assoc())
    {
        ...
        echo '<td>';
         //update/edit
         echo '<form action="counterstrikeupdate.php" class="d-inline" method="POST">';
...
$sql = "DELETE FROM counterstrike WHERE TeamName = '{$_REQUEST['id']}'";
...
?>
<div class="float-right"><a href="counterstrikeadd.php" class="btn btn-danger"><i class="fas fa-plus fa-2x"></i></a></div>
