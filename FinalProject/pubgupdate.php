...
//See if the fields are empty
{
 ...
 //if the fields are not empty   
    else
    {
        ...
        $sql = "UPDATE pubg SET MatchesPlayed = '$MatchesPlayed', Lost = '$Lost', Penalty = '$Penalty', Score = '$Score' , Won = '$Won' , TeamName = '$TeamName' WHERE id = $id";  
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <?php
   ...
   {
    $sql = "SELECT * FROM pubg WHERE id = '{$_REQUEST['id']}'";
  ...
  <div class="text-center">
    <button type="submit" class="btn btn-danger" id="pubg" name="pubg">Update</button>
    <a href="pubg.php" class="btn btn-secondary">Close</a>
  </div>
