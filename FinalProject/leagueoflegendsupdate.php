...
if(isset($_REQUEST['leagueoflegends']))
//See if the fields are empty
{
 ...
 //if the fields are not empty   
    else
    {
        ...
        $sql = "UPDATE leagueoflegends SET MatchesPlayed = '$MatchesPlayed', Lost = '$Lost', Penalty = '$Penalty', Score = '$Score' , Won = '$Won' , TeamName = '$TeamName' WHERE id = $id";  
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <?php
   ...
   {
    $sql = "SELECT * FROM leagueoflegends WHERE id = '{$_REQUEST['id']}'";
  ...
  <div class="text-center">
    <button type="submit" class="btn btn-danger" id="leagueoflegends" name="leagueoflegends">Update</button>
    <a href="leagueoflegends.php" class="btn btn-secondary">Close</a>
  </div>
