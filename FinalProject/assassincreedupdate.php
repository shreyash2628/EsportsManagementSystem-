...
if(isset($_REQUEST['assassincreed']))
//See if the fields are empty
{
 ...
 //if the fields are not empty   
    else
    {
        ...
        $sql = "UPDATE assassincreed SET MatchesPlayed = '$MatchesPlayed', Lost = '$Lost', Penalty = '$Penalty', Score = '$Score' , Won = '$Won' , TeamName = '$TeamName' WHERE id = $id";  
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <?php
   ...
   {
    $sql = "SELECT * FROM assassincreed WHERE id = '{$_REQUEST['id']}'";
  ...
  <div class="text-center">
    <button type="submit" class="btn btn-danger" id="assassincreed" name="assassincreed">Update</button>
    <a href="assassincreed.php" class="btn btn-secondary">Close</a>
  </div>
