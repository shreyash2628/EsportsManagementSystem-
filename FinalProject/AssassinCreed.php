...
?>
    ...
    <div class="col-md-10 mt-5 text-left">
        ...
        <div class="col-sm-4 col-md-10 mt-5 text-center">
            <p class="bg-dark text-white p-2">ASSASSIN'S CREED SCOREBOARD</p>
<?php            
$sql ="SELECT * FROM assassincreed";
...
if($result->num_rows > 0)
{
    ...
    while($row = $result->fetch_assoc())
    {
        ...
        echo '<td>';
         //update/edit
         echo '<form action="assassincreedupdate.php" class="d-inline" method="POST">';
...
$sql = "DELETE FROM assassincreed WHERE TeamName = '{$_REQUEST['id']}'";
...
?>
<div class="float-right"><a href="assassincreedadd.php" class="btn btn-danger"><i class="fas fa-plus fa-2x"></i></a></div>            
<?php
